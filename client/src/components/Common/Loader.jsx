...
const Loader = () => (
  <div className="flex flex-col items-center justify-center min-h-screen bg-white">
    ...
    <div className="relative flex items-center justify-center">
      <div className="absolute w-20 h-20 rounded-full border-4 border-black animate-pulse opacity-20"></div>
      <div className="absolute w-28 h-28 rounded-full bg-black animate-ping opacity-10"></div>

      {/* Custom spinning ring with drop shadow */}
      <svg
        className="w-14 h-14 text-black animate-spin drop-shadow-md"
        viewBox="0 0 100 101"
        fill="none"
    ...
    {/* Fancy Loading Text */}
    <p className="mt-6 text-base font-medium tracking-widest text-black animate-pulse">
      loading...
    </p>
  </div>
);
